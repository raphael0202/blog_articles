...
Devant le refus de mon chef d'équipe, je me suis tourné vers le cluster de calcul tournant sous *OGE* mis à la disposition de mon laboratoire. C'est dans ce genre de cas où un système de gestion de grille comme *OGE* est pertinent, car il permet de faire l'analyse des 150 génomes en parallèle, et réduit donc d'autant le temps de calcul.
